...
public class Blitz {
  ...
  public enum Option {
    ...
    /** Generator option: Skip a word and reparse on parsing error.  */ SKIP_UNMATCHED_WORDS,
    /** Generator option: After a match, reparse for a next match.   */ MULTIPLE_MATCHES,
